...
\begin{figure}[!htbp]
  ...
  \begin{tabular}{@{}cc@{}}
    \begin{minipage}[t]{0.48\linewidth}
      ...
      \small ``second wedge grapefruit from left to right''\\[0.25em]
      ...
      \small DINO 0.97 \hfill Locate-SAM2 0.00
    \end{minipage}
    &
    \begin{minipage}[t]{0.48\linewidth}
      \centering
      \textbf{Spatial / ordinal}\\[-0.1em]
      \small ``zebra on left''\\[0.25em]
      ...
      \small DINO 0.94 \hfill Locate-SAM2 0.28
    \end{minipage}
    \\[0.8em]
    \begin{minipage}[t]{0.48\linewidth}
      \centering
      \textbf{Attribute ambiguity}\\[-0.1em]
      \small ``red bike''\\[0.25em]
      ...
      \small DINO 0.74 \hfill Locate-SAM2 0.12
    \end{minipage}
    &
    \begin{minipage}[t]{0.48\linewidth}
      \centering
      \textbf{Rare / long expression}\\[-0.1em]
      \small ``mtf member whole pizza''\\[0.25em]
      ...
      \small DINO 0.99 \hfill Locate-SAM2 0.00
    \end{minipage}
  \end{tabular}
  \caption{%
...
\begin{figure}[!htbp]
  ...
  \begin{tabular}{@{}cc@{}}
    ...
    \small Input image &
    \small Locate-SAM2 output for nonsense prompt
  \end{tabular}
  \caption{%
